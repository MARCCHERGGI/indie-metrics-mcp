...
import { z } from "zod";
import { getRevenueSummary, getCustomerMetrics, getProductPerformance, getSubscriptionHealth, getRecentTransactions, getRefundAnalysis, getRevenueForecast, } from "./analytics.js";
...
server.registerTool("get_revenue_summary", {
    ...
    description: "Get a complete revenue overview including MRR, ARR, total revenue, transaction count, " +
...
server.registerTool("get_customer_metrics", {
    ...
    description: "Get customer analytics including total customers, new customers in period, " +
...
server.registerTool("get_product_performance", {
    ...
    description: "Analyze revenue by product — shows each product's revenue, units sold, " +
...
server.registerTool("get_subscription_health", {
    ...
    description: "Full subscription analytics: active subscriptions, churn rate, MRR, ARPU, " +
...
server.registerTool("get_recent_transactions", {
    ...
    description: "List recent charges and payments with amount, status, customer email, " +
...
server.registerTool("get_refund_analysis", {
    ...
    description: "Analyze refunds: total count, amount, refund rate vs successful charges, " +
...
server.registerTool("get_revenue_forecast", {
    ...
    description: "Predict future revenue based on recent trends. Shows current MRR, projected monthly " +
